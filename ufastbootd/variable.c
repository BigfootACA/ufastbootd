...
void fastboot_init_variables(){
	...
	fb_set_var_string("version-baseband","0.0.1");
	...
	fb_set_var_string("product","ufastbootd");
	fb_set_var_string("variant","ufastbootd");
	fb_set_var_string("serialno","1230189191415411");
